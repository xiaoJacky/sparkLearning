...
public class JMSReceiver extends Receiver<JMSEvent> implements MessageListener {
    ...
    private static final String JNDI_INITIAL_CONTEXT_FACTORY = "org.apache.activemq.jndi.ActiveMQInitialContextFactory";
    private static final String JNDI_CONNECTION_FACTORY_NAME = "ConnectionFactory";
    private static final String JNDI_QUEUE_NAME = "RTEEQueue";
    ...
    public void onStart() {
        ...
        try {
            ...
            env.put(Context.PROVIDER_URL, _brokerURL);
